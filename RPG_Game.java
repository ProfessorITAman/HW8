...
public class RPG_Game {
    ...
    public static void startGame() {
        Boss boss = new Boss("Skelet", 2000, 70);
        ...
        Avenger avenger = new Avenger("Vengeance", 270, 15);
        Deku deku = new Deku("Deku", 230, 20);
        Bomber bomber = new Bomber("Bomberman", 100, 30);

        Hero[] heroes = {warrior1, doc, warrior2, magic, berserk, assistant, avenger, deku, bomber};
